 ...
 * @author ACER
 */
public class MhsFilkom extends Manusia{
    private String NIM;
    private double IPK;

    public MhsFilkom(String NIM, double IPK, String nama, String NIK, boolean jenisKelamin, boolean menikah) {
        super(nama, NIK, jenisKelamin, menikah);
        this.NIM = NIM;
        this.IPK = IPK;
    }

    MhsFilkom(String _38_) {
